...
export PATH=/home/laofahai/.nvm/versions/node/v23.11.1/bin\:/home/laofahai/.bun/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
